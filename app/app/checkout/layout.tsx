...
import GlobalFormLoading from "@/components/GlobalFormLoading";
export const metadata = {
  title: "Bodega Shopping Checkout",
  description: `Cart for e-ecommerce, selling products, and new productivity`,
};

export default function CheckoutLayout({ children }: { children: React.ReactNode }) {
  return <>
    <div className="m-0 min-w-0 flex flex-col h-screen pt-[56px] md:pt-[62px]">
      <header className="fixed top-0 left-0 right-0 z-[9] shadow-none bg-white">
        <div className="min-w-0 flex items-center justify-between px-4 py-[15px] bg-[#0e5aa7] max-w-[1232px] mx-auto font-montserrat not-italic xs:px-6 md:px-0 md:bg-transparent">
          <div className="m-0 min-w-0 cursor-pointer items-center text-white flex text-sm">
            <svg id="ArrowLeft" viewBox="0 0 24 24" className="-ml-[6px] w-[22px] h-[15px]"><path fill="#fff" d="M17.2,2.4l-0.7-0.7l-9.9,9.9c-0.2,0.2-0.2,0.5,0,0.7c0,0,0,0,0,0l10.1,10.1l0.7-0.7l-9.8-9.8L17.2,2.4z"></path></svg>
            Cart
          </div>
          <div className="m-0 min-w-0 text-white md:hidden">Complete your order</div>
          <a href="tel:254 712345678" className="m-0 min-w-0 no-underline text-[#0e5aa7] text-sm font-medium hidden md:block">Need Help? 254 712345678</a>
          <div className="m-0 -mr-[76px] min-w-0 xs:-mr-[68px] md:order-[-1] md:mr-0">
            <a href="/" className="m-0 min-w-0 flex">
              <svg
                width="99"
                height="36"
                viewBox="0 0 209 76"
		...
		c-15.38,0-27.84-12.47-27.84-27.84l0,0C61.96,21.79,74.43,9.33,89.8,9.33z"/>
          ...
          <i className="m-0 min-w-0 absolute right-0 top-0 bottom-0 bg-[#0E5AA7] p-2 xs:p-4 md:hidden">

          </i>
        </div>
      </header>
      <main className="m-0 min-w-0 block" style={{ flex: '1 0 auto' }}>
        <GlobalError />
        {children}
      </main>
      <Footer />
