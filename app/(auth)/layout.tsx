...
const layout = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className="flex flex-col bg-center bg-no-repeat bg-cover pt-[80px] justify-center p-4 min-h-[100vh] items-center"
            style={{ backgroundImage: "url('https://cdnprod.mafretailproxy.com/assets/home-web/bg-main.webp')" }}>
            <div className="min-w-0 my-1 mx-0">
